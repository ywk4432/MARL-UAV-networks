...
class SmallTimsecaleRunner:
    ...
    def run(self, test_mode=False):
        ...
        luav_act_list = self.args.luav_act_list
        ...
        if test_mode and (len(self.test_returns) == n_test_runs):
            ...
            self._log(cur_returns, cur_stats, log_prefix)
            if hasattr(self.f_mac.action_selector, "epsilon"):
                self.logger.log_stat(
                    "epsilon", self.f_mac.action_selector.epsilon, self.t_env
                )
