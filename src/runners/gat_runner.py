...
class GATRunner:
    ...
    def reset(self):
        ...
        for parent_conn in self.parent_conns:
            ...
            pre_transition_data["adjacency"].append(data["adjacency"])
    ...
    def run(self, test_mode=False):
        ...
        while True:
            ...
            for idx, parent_conn in enumerate(self.parent_conns):
                if not terminated[idx]:
                    ...
                    if test_mode:
                        reward_list[idx].append(data["reward"])
        ...
        if test_mode:
            ...
            for parent_conn in self.parent_conns:
                parent_conn.send(("record", (self.ps[0].pid, self.args.run_id)))
...
def env_worker(remote, env_fn):
    ...
    while True:
        ...
        if cmd == "step":
            ...
            rewards_agents, reward, terminated, env_info = env.step(actions)
