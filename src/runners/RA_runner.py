    ...
    def run(self, test_mode=False):
        ...
        while True:
            if slot_step == 0:
                ...
                data = {
                    "f_state": self.env.get_state(),
                    "f_avail_actions": self.env.get_f_avail_actions(),
                    "f_obs": self.env.get_fuav_obs(),
                }
                ...
                l_reward, f_reward_agents, f_reward, slot_end, terminated, env_info = (
                    self.env.step(slot_step, f_cpu_actions)
                )
                ...
                f_post_transition_data["agent_reward"].append((data["f_agent_reward"],))
